...
commands = [
    ...
    Command(2, "[^别不]*(老婆|我爱你|我爱死你了|我喜欢你|踩|结婚|嫁给我|suki).*", my_wife, priority=4, need_at=True, next=True),
    Command(3, ".*(可爱|卡瓦|kawa|kawaii|kawai|kwi|卡哇伊|かわいい|かわ|かわい).*", knd_kawaii, need_at=True, next=True),
    Command(4, "^[嗦吃喝][泡杯]?面$", eat_noodles, need_at=True, next=True),
    Command(5, "^(早|早安|早上好|上午好|中午好|午安|下午好|晚上好|[咱我俺偶]要?去?睡觉?了"
