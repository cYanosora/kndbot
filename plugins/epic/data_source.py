        ...
        for game in games:
            ...
            try:
                ...
                if not game_promotions and not upcoming_promotions:
                    if type_event == "Group":
                        _message = "由 {} 公司发行的游戏 {} (价格：{}) 目前已经上线".format(
                            game_corp, game_name, "免费" if game_price == "0" else game_price
                        )
                        data = {
                            "type": "node",
                            "data": {
                        ...
                        msg = "由 {} 公司发行的游戏 {} (价格：{}) 目前已经上线".format(
                            game_corp, game_name, "免费" if game_price == "0" else game_price
                        )
                        msg_list.append(msg)
                    ...
                    if type_event == "Group":
                        ...
                        msg = "由 {} 公司发行的游戏 {} ({}) 在 UTC 时间 {} 即将推出免费游玩，预计截至 {}。".format(
                            game_corp, game_name, game_price, start_date, end_date
                        )
                        msg_list.append(msg)
                else:
