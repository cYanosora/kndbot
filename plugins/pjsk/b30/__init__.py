...
from .._config import data_path, NOT_IMAGE_ERROR, BUG_ERROR, api_base_url_list, suite_path
...
async def _(event: MessageEvent, msg: Message = CommandArg()):
    ...
    profile = UserProfile()
    try:
        data = await callapi(random.choice(api_base_url_list) + f'/user/{userid}/profile', query_type='b30')
        await profile.getprofile(userid, 'b30', data)
    except pjskError as e :
        await pjsk_b30.finish(str(e))
    except:
