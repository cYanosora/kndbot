...
async def drawevent(event: EventInfo):
    ...
    for chara in event.bonusechara:
        bonuspic = await charabonuspic(chara, event.bonuseattr, cards, gameCharacterUnits, event.aggregateAtorin)
...
async def charabonuspic(unitid, attr, cards, gameCharacterUnits, endtime):
