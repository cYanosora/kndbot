...
def parse_language(language_type):
    if language_type in ["英翻", "英文翻译"]:
        return "EN2ZH_CN"
    if language_type in ["日翻", "日文翻译"]:
        return "JA2ZH_CN"
    if language_type in ["韩翻", "韩文翻译"]:
        return "KR2ZH_CN"
    # if language_type == '法翻':
    #     return 'FR2ZH_CN'
    # if language_type == '俄翻':
    #     return 'RU2ZH_CN'
    if language_type in ["翻英", "翻译英文"]:
        return "ZH_CN2EN"
    if language_type in ["翻日", "翻译日文"]:
        return "ZH_CN2JA"
    if language_type in ["翻韩", "翻译韩文"]:
        return "ZH_CN2KR"
    # if language_type == '翻法':
    #     return 'ZH_CN2FR'
    # if language_type == '翻俄':
